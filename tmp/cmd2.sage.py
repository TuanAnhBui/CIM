...
# This file was *autogenerated* from the file ./tmp/cmd2.sage
...
with open(os.path.expanduser("./logs/log2.txt"),"a+") as f:
    f.write('Finished loading the boundary map C'+str(n-_sage_const_1 )+'_C'+str(n)+'\n')
    f.write('It took '+str(time()-run_time)+' seconds!'+'\n')
run_time = time() 
load("./tmp/C2_C3.sage")
with open(os.path.expanduser("./logs/log2.txt"),"a+") as f:
    f.write('Finished loading the boundary map C'+str(n)+'_C'+str(n+_sage_const_1 )+'\n')
    f.write('It took '+str(time()-run_time)+' seconds!'+'\n')
run_time = time() 
load("./tmp/D1_D2.sage")
with open(os.path.expanduser("./logs/log2.txt"),"a+") as f:
    f.write('Finished loading the boundary map D'+str(n-_sage_const_1 )+'_D'+str(n)+'\n')
    f.write('It took '+str(time()-run_time)+' seconds!'+'\n')
run_time = time() 
load("./tmp/D2_D3.sage")
with open(os.path.expanduser("./logs/log2.txt"),"a+") as f:
    f.write('Finished loading the boundary map D'+str(n)+'_D'+str(n+_sage_const_1 )+'\n')
    f.write('It took '+str(time()-run_time)+' seconds!'+'\n')
run_time = time() 
load("./tmp/f2.sage")
with open(os.path.expanduser("./logs/log2.txt"),"a+") as f:
...
W2 = N1.image()
with open(os.path.expanduser("./logs/log2.txt"),"a+") as f:
    f.write('Computation of the image of N'+str(n-_sage_const_1 )+' has been done! ')
    f.write('It took '+str(time()-run_time)+' seconds!'+'\n')
run_time = time() 
Q2 = V2/W2
B = Q2.basis()
